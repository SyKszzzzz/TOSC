...
class NumpyToTensor(object):
    ...
    def __call__(self, data: Dict, *args: List, **kwargs: Dict) -> dict:
        for key in data.keys():
            ...
            # print("key is ", key)
            if key in ['x', 'pos', 'feat', 's_grid_sdf', 's_grid_min', 's_grid_max', 'start', 'end', 'ins_disc', 'ins_mask_disc', 'task_disc','task_mask_disc', 'obj_disc','obj_mask_disc', 'obj_L0_part_disc', 'obj_L0_part_disc_mask', 'obj_L0_valid_part','obj_L1_part_disc', 'obj_L1_part_disc_mask', 'obj_L1_valid_part'] and not torch.is_tensor(data[key]):
