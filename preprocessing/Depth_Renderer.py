...
# blender -b -P Depth_Renderer.py E:/dataset/OakInk/OakInkObjectsV2 test.txt E:/dataset/OakInk/render/dump 10
# blender -b -P Depth_Renderer.py E:/dataset/OakInk/OakInkObjectsV2 OakInkObjectsV2.txt E:/dataset/OakInk/render/OakInkObjectsV2 10
...
import os, sys, bpy, time, mathutils
import numpy as np
...
def random_pose():
    ...
    distance_factor = 0.5
    t = np.expand_dims(R[:, 2] * distance_factor, 1)  # select the third column, reshape into (3, 1)-vector
...
def setup_blender(width, height, focal_length):
    ...
    output.format.color_mode = 'RGBA'  # 包含颜色和 alpha 通道
...
if __name__ == '__main__':
    ...
    for idx, model_id in enumerate(model_list):
        ...
        print("exr_dir  is ", exr_dir)
        print("pose_dir is ", pose_dir)
        ...
        bpy.context.scene.render.filepath = "E/dataset/OakInk/render/buffer.png"
        # Render
        for i in range(num_scans):
            ...
            print("tset!!!!!", output.file_slots[0].path )
